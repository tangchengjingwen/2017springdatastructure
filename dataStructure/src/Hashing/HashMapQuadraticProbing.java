...
public class HashMapQuadraticProbing {
	...
	public HashMapQuadraticProbing(int initialSize) {
	...
	public static void main(String[] args) throws Exception {
		HashMapQuadraticProbing m = new HashMapQuadraticProbing(1000);
		m.load("dict1.txt");
		// m.load("c++keywords.dat");
		/*
		 * Integer v = m.get("cat"); if (v != nullptr) { cout << v.intValue() <<
		 * '\n'; }
		 */
